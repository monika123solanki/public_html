...
?>
			<ul id="<?php echo $menu_group_id; ?>" class="<?php echo $menu_class; ?>">
				...
				foreach ($arrMenu as $menu_obj) {
					...
					//acl validationif ($user->canView($menu_path)) {
					$active_class = null;
	...
	public static function import_form($form_path, $button_text = "")
	{
		$formid = random_str();
		?>
		<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#import-data-form-<?php echo $formid ?>">
			...
			<div class="modal-dialog modal-dialog-centered modal-sm">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title"><?php echo __('import_data') ?></h4>
					...
					<div class="modal-body">
						<div class="custom-file" id="customFile" lang="<?php echo app()->getLocale(); ?>">
							...
							<label class="custom-file-label" for="inputfile">
								<?php echo __('select_a_file_to_import') ?> 
							</label>
						</div>
						<small class="text-muted"><?php echo __('supported_file_types') ?>(csv)</small>
					</div>
					<div class="modal-footer">
						<button type="reset" class="btn btn-secondary" data-dismiss="modal"><?php echo __('close') ?></button>
						<button type="submit" class="btn btn-primary"><?php echo __('import_data') ?></button>
					</div>
				</div>
			</div>
		</form>
