...
<?php
    $pageTitle = __('permissions_details');
?>
@extends($layout)
            ...
            <div class="row justify-content-between">
                <div class="col-12 col-md-auto " >
                    <div class="row  q-col-gutter-sm q-px-sm" >
                        <div class="col">
                            <div class="h5 font-weight-bold text-primary">{{ __('permissions_details') }}</div>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="page-data">
                                        ...
                                        <div class="border-top td-permission_name p-2">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <div class="text-muted"> {{ __('permission_name') }}</div>
                                                    <div class="font-weight-bold">
