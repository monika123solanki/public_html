            ...
            <div class="row justify-content-between">
                <div class="col-12 col-md-auto " >
                    <div class="row  q-col-gutter-sm q-px-sm" >
                        <div class="col">
                            <div class="h5 font-weight-bold text-primary">{{ __('state_details') }}</div>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="page-data">
                                        ...
                                        <div class="border-top td-state_title p-2">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <div class="text-muted"> {{ __('state_title') }}</div>
                                                    <div class="font-weight-bold">
                                        ...
                                        <div class="border-top td-state_description p-2">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <div class="text-muted"> {{ __('state_description') }}</div>
                                                    <div class="font-weight-bold">
