            ...
            <div class="row justify-content-between">
                <div class="col-12 col-md-auto " >
                    <div class="row  q-col-gutter-sm q-px-sm" >
                        <div class="col">
                            <div class="h5 font-weight-bold text-primary">{{ __('add_new_roles') }}</div>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-role_name-holder" class=" ">
                                                <input id="ctrl-role_name"  value="<?php echo get_value('role_name') ?>" type="text" placeholder="{{ __('enter_role_name') }}" list="role_name_list"  required="" name="role_name"  class="form-control " />
                                                ...
                                                <?php
                                                    ...
                                                    $value = $option['value'];
                                                    $label = $option['label'];
                                                    $selected = Html::get_field_selected('role_name', $value);
                                                ?>
