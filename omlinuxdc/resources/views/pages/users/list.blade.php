                                    ...
                                    <table class="table table-hover table-striped table-sm text-left">
                                        <thead class="table-header ">
                                            <tr>
                                                ...
                                                <th class="td-first_name" > {{ __('first_name') }}</th>
                                                <th class="td-last_name" > {{ __('last_name') }}</th>
                                                <th class="td-profile_picture" > {{ __('profile_picture') }}</th>
                                                <th class="td-email" > {{ __('email') }}</th>
                                                <th class="td-special_instruction" > {{ __('special_instruction') }}</th>
                                                <th class="td-mobile_number" > {{ __('mobile_number') }}</th>
                                                <th class="td-state_id" > {{ __('state_id') }}</th>
                                                <th class="td-role_id" > {{ __('role_id') }}</th>
                                                <th class="td-city_id" > {{ __('city_id') }}</th>
                                        ...
                                        <tbody class="page-data">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-profile_picture">
                                                    <?php 
                                                        Html :: page_img($data['profile_picture'],50,50, "medium", "large", 1); 
                                                    ?>
                                                </td>
                                                <td class="td-email">
                                                    <a href="<?php print_link("mailto:$data[email]") ?>"><?php echo $data['email']; ?></a>
                                                </td>
                                                <td class="td-special_instruction">
                                                    <?php echo  $data['special_instruction'] ; ?>
                                                </td>
                                                <td class="td-mobile_number">
                        ...
                        <div class="row justify-content-center">    
                            <div class="col-md-auto justify-content-center">    
                                <div class="p-3 d-flex justify-content-between">    
                                    <button data-prompt-msg="{{ __('are_you_sure_you_want_to_delete_these_records') }}" data-display-style="modal" data-url="<?php print_link("users/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
