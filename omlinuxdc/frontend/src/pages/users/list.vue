                                            ...
                                            <template >
                                                ...
                                                <template v-slot:body="props">
                                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                        ...
                                                        <q-td  key="profile_picture" :props="props">
                                                            <image-viewer image-size="medium" image-preview-size="" :src="props.row.profile_picture" width="50px" height="50px" :num-display="1">
                                                            </image-viewer>
                                                        </q-td>
                                                        ...
                                                        <q-td  key="special_instruction" :props="props">
                                                            {{ props.row.special_instruction }}
                                                        </q-td>
