                        ...
                        <div class="col-12 col-md-auto " >
                            <div class="" >
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">{{ $t('templates_details') }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <template v-if="!loading && item">
                                        <div class="row q-col-gutter-x-md">
                                            <div class="col">
                                                ...
                                                <q-item>
                                                    <q-item-section>
                                                        <q-item-label caption>{{ $t('templates_name') }}: </q-item-label>
                                                        <q-item-label class="text-bold">{{ item.templates_name }}</q-item-label>
                                                    </q-item-section>
                                                </q-item>
                                                <q-separator></q-separator>
                                                <q-item>
                                                    <q-item-section>
                                                        <q-item-label caption>{{ $t('templates_type') }}: </q-item-label>
                                                        <q-item-label class="text-bold">{{ item.templates_type }}</q-item-label>
                                                    </q-item-section>
                                                </q-item>
                                                <q-separator></q-separator>
                                                <q-item>
                                                    <q-item-section>
                                                        <q-item-label caption>{{ $t('templates_command') }}: </q-item-label>
                                                        <q-item-label class="text-bold">{{ item.templates_command }}</q-item-label>
                                                    </q-item-section>
                                                </q-item>
                                                <q-separator></q-separator>
                                                <q-item>
                                                    ...
                                                    <q-btn icon="menu" padding="xs" round flat color="grey">
                                                        <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                            <q-list dense rounded nav>
                                                                <q-item link clickable v-ripple :to="`/templates/edit/${item.id}`">
                                                                    <q-item-section>
...
<script>
	...
	export default {
		...
		computed: {
			pageTitle:{
				get: function () {
					return this.$t('templates_details')
				}
			},
			currentRecord: {
				get: function () {
		...
		methods: {
			...mapActions("templates", [ "fetchRecord", "deleteRecord"]),
		},
		watch: {
			$route (to, from){
