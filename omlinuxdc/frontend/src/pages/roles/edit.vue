                                                    ...
                                                    <div class="col-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9 col-12">
                                                                <ValidationProvider :rules="{required:true}" :name="$t('role_name')" v-slot="{ errors, invalid, validated }">
                                                                    <q-input outlined dense  ref="ctrlrole_name" v-model.trim="formData.role_name"  :label="$t('role_name')" type="text" :placeholder="$t('enter_role_name')"   list="role_name_list"    
