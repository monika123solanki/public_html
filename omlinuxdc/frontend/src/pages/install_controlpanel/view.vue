                        ...
                        <div class="col-12 col-md-auto " >
                            <div class="" >
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">{{ $t('install_controlpanel_details') }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <template v-if="!loading && item">
                                        <div class="row q-col-gutter-x-md">
                                            <div class="col">
                                                ...
                                                <q-item>
                                                    <q-item-section>
                                                        <q-item-label caption>{{ $t('select_remote_server') }}: </q-item-label>
                                                        <q-item-label class="text-bold">{{ item.select_remote_server }}</q-item-label>
                                                    </q-item-section>
                                                </q-item>
                                                <q-separator></q-separator>
                                                <q-item>
                                                    <q-item-section>
                                                        <q-item-label caption>{{ $t('installer_name') }}: </q-item-label>
                                                        <q-item-label class="text-bold">{{ item.installer_name }}</q-item-label>
                                                    </q-item-section>
                                                </q-item>
                                                <q-separator></q-separator>
                                                <q-item>
                                                    <q-item-section>
                                                        <q-item-label caption>{{ $t('product_name') }}: </q-item-label>
                                                    ...
                                                    <q-btn icon="menu" padding="xs" round flat color="grey">
                                                        <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                            <q-list dense rounded nav>
                                                                <q-item link clickable v-ripple :to="`/install_controlpanel/edit/${item.id}`">
                                                                    <q-item-section>
...
<script>
	...
	export default {
		name: 'viewInstallcontrolpanelPage',
		components: {
		},
		...
		props: {
			...
			routeName : {
				type : String,
				default : 'install_controlpanelview',
			},
			pagePath: {
				type : String,
				default : 'install_controlpanel/view',
			},
			apiPath: {
				type : String,
				default : 'install_controlpanel/view',
		...
		computed: {
			pageTitle:{
				get: function () {
					return this.$t('install_controlpanel_details')
				}
			},
			currentRecord: {
				get: function () {
		...
		methods: {
			...mapActions("install_controlpanel", [ "fetchRecord", "deleteRecord"]),
		},
		watch: {
			$route (to, from){
